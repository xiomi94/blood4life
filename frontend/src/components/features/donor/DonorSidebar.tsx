  ...
  return (
    <>
      ...
      `}>
        ...
        <div className="px-4 mb-6 mt-12 lg:mt-0 relative group">
          <button
            onClick={() => {
              if (!buttonDisabled && onNewDonationClick) {
                onNewDonationClick();
                closeMobileMenu();
              }
            }}
            ...
            ${buttonDisabled
                ...
                : 'bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 dark:from-blue-600 dark:to-blue-700 dark:hover:from-blue-500 dark:hover:to-blue-600 text-white hover:scale-[1.02]'
              }`}>
