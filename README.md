...
![Gaphor](./docs/gaphorIcon.webp)

**Purpose:**  
Gaphor is used in Blood4Life for **modeling and designing UML diagrams** such as class diagrams, use case diagrams, and entity-relationship diagrams. It helps the team visualize the architecture and relationships between components of the application.

**Why Gaphor was chosen:**
- **Lightweight and easy to use:** Quick to install and start modeling without complex setup.
- **Supports standard UML diagrams:** Fully compatible with industry-standard UML notation.
- **Open-source:** Free to use, which is ideal for educational and team projects.
- **Cross-platform:** Works on Windows, Linux, and macOS.
- **Export capabilities:** Diagrams can be exported as images or SVGs to include in documentation, presentations, or README files.

**Advantages over alternatives (e.g., StarUML, Visual Paradigm):**
- Simpler interface for beginners and students.
- Faster modeling for small to medium projects.
- No licensing costs, unlike some commercial UML tools.

**Use in Blood4Life:**
- Design **class diagrams**, **ER diagrams**, and **use case diagrams** for backend and frontend architecture.
- Serve as visual documentation in the README.md and internal project documentation.
- Facilitate communication between developers by providing a clear graphical representation of system components.
...
* [![JDK 17](https://img.shields.io/badge/-JDK_17-437291?style=flat&logo=openjdk&logoColor=white)](https://docs.aws.amazon.com/corretto/latest/corretto-17-ug/downloads-list.html)
* [![Node.js](https://img.shields.io/badge/-Node.js-339933?style=flat&logo=nodedotjs&logoColor=white)](https://nodejs.org/en/download/)
* [![IntelliJ](https://img.shields.io/badge/-IntelliJ_IDEA-000000?style=flat&logo=intellijidea&logoColor=white)](https://www.jetbrains.com/es-es/idea/) (Or another IDE, what you want, we chose this)
